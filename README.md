...
对话（`/chat`）组织文献与研究任务，PDF 附件可进入独立的「阅研」阅读工作台；Agent 按需调度类型化工具与技能：

- **阅研 · PDF 阅读工作台** — 从当前会话的 PDF 附件打开原版阅读页面，支持连续滚动、单页翻阅、宽屏双页、目录、缩放和阅读位置恢复。划选后可专业翻译、解释、追问、划线或记下发现；译文参考页内语境与本篇术语表，助读回答支持数学公式。阅读讨论独立保存，笔记保留原文出处和自己的判断，点击“带回对话”后可继续比较与写作，再从聊天中的链接返回原文。
...
1. 从聊天右侧的“工作台”进入阅读空间，选择当前会话论文，再打开阅读工作台；边栏收起时仍有独立“工作台”按钮。没有论文时可先在聊天中选择 PDF 并点击“只上传，开始阅读”，无需发送模型消息。附件上的快捷入口仍可使用。
